            ...
            cameras={
                "articulated_agent_arm_depth": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(
                        0.166, 0.0, 0.018
                    ),  # mn.Vector3(0.166, 0.0, 0.0), #mn.Vector3(0.166, 0.0, 0.018), #mn.Vector3(0.166, 0.0, 0.0), #mn.Vector3(0.166, 0.0, 0.018),
                    cam_orientation=mn.Vector3(
                        0, -1.571, 0.0
                    ),  # mn.Vector3(0, -1.431, 0.0), #mn.Vector3(0, -1.35, 0.0), #mn.Vector3(0, -1.35, 0.0), #mn.Vector3(0, -1.571, 0.0),
                    attached_link_id=6,
                ...
                "articulated_agent_arm_rgb": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(
                        0.166, 0.023, 0.03
                    ),  # mn.Vector3(0.166, 0.0, 0.0),  #mn.Vector3(0.166, 0.023, 0.03), #mn.Vector3(0.166, 0.0, 0.0), #mn.Vector3(0.166, 0.023, 0.03),
                    cam_orientation=mn.Vector3(
                        0, -1.571, 0.0
                    ),  # mn.Vector3(0, -1.431, 0.0), #mn.Vector3(0, -1.35, 0.0), #mn.Vector3(0, -1.35, 0.0), #mn.Vector3(0, -1.571, 0.0),
                    attached_link_id=6,
                ...
                #     cam_offset_pos=mn.Vector3(0.4164822634134684, 0.0, 0.00),
                #     #cam_look_at_pos=mn.Vector3(0, -1.571, 0.0),
                #     cam_orientation=mn.Vector3(0, 0.0, 0.0),
                #     attached_link_id=-1,
                # ),
