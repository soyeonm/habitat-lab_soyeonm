...
class SpotRobot(MobileManipulator):
    def _get_spot_params(self):
        return SpotParams(
            ...
            arm_init_params=[0.0, -3.14, 0.0, 3.14, 0.0, 0.0, 0.0],
            ...
            ee_offset=[mn.Vector3(0.08, 0, 0)],#mn.Vector3(0.08, 0, 0)],
            ee_links=[7],
            ...
            cameras={
                "articulated_agent_arm_depth": ArticulatedAgentCameraParams(
                    ...
                    cam_orientation=mn.Vector3(0, -1.57079632679, -0.25618528283),#-0.3),
                    attached_link_id=6,
                    relative_transform=mn.Matrix4.rotation_z(mn.Deg(-90)),
                ),
                "articulated_agent_arm_rgb": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(0.166, 0.0, 0.018),
                    cam_orientation=mn.Vector3(0, -1.57079632679, -0.25618528283),
                    attached_link_id=6,
                    relative_transform=mn.Matrix4.rotation_z(mn.Deg(-90)),
                ),
                "articulated_agent_arm_rgb_down": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(0.166, 0.0, 0.018),
                    cam_orientation=mn.Vector3(0, -1.2, -0.25618528283), #Can change to 0.8
                    attached_link_id=6,
                    relative_transform=mn.Matrix4.rotation_z(mn.Deg(-90)),
                ),
                "articulated_agent_arm_depth_down": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(0.166, 0.0, 0.018),
                    cam_orientation=mn.Vector3(0, -1.2, -0.25618528283),
                    attached_link_id=6,
                    relative_transform=mn.Matrix4.rotation_z(mn.Deg(-90)),
                ),
                ...
                "articulated_agent_arm_panoptic_look_down": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(0.166, 0.0, 0.018),
                    cam_orientation=mn.Vector3(0, -1.2, -0.25618528283),
                    attached_link_id=6,
                    relative_transform=mn.Matrix4.rotation_z(mn.Deg(-90)),
